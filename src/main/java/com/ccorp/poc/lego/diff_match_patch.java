...
public class diff_match_patch {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String html2 =
                "";
        BufferedReader bufferedReader = new BufferedReader(new FileReader(new File("c:/test.html")));
...
//        bufferedReader.close();
        BufferedReader bufferedReader1 = new BufferedReader(new FileReader(new File("c:/test1.html")));
//        String content1 = bufferedReader1.readLine();
//        while(content1 != null){
//            html2 += content1 + "\n";
...
//        tidy.setXmlOut(true);
        tidy.parse(bufferedReader, sw);
        tidy.parse(bufferedReader1, sw1);


        LinkedList<Diff> linkedList = new diff_match_patch().diff_main(sw.toString(), sw1.toString());
        System.out.println(new diff_match_patch().diff_prettyHtml(linkedList));
//        for(Diff d : linkedList){
